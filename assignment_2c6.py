...
inputMat, numOfTimePeriods = readInputs("input2b6.txt")
...
print("\nShortest path from node " + str(source_node) + " to node " + str(target_node) + " is: " + str(shortest_path))
print("Total cost to reach node " + str(target_node) + " is: " + str(shortest_distance))
print("The value of K is: " + str(K))
print("The minimal cost for the lotsizing problem is: " + str(shortest_distance - K))